...
kordic = { 'ㅒ':'O', 'ㄻ':'fa', 'ㄼ':'fq', 'ㄽ':'ft', 'ㄾ':'fx', 'ㄿ':'fv', 'ㅀ':'fg', 'ㄳ':'rt', 'ㄵ':'sw', 'ㅞ':'np', 'ㄺ':'fr', 'ㅄ':'qt', 'ㅆ':'T', 'ㅖ': 'P', 'ㄶ':'sg', 'ㄸ':'E', 'ㅉ':'W', 'ㅃ':'Q', 'ㄲ':'R', 'ㅂ':'q', 'ㅈ':'w', 'ㄷ':'e', 'ㄱ':'r', 'ㅅ':'t', 'ㅛ':'y', 'ㅕ':'u', 'ㅑ':'i', 'ㅐ':'o', 'ㅔ':'p', 'ㅁ':'a', 'ㄴ':'s', 'ㅇ':'d', 'ㄹ':'f', 'ㅎ':'g', 'ㅗ':'h', 'ㅓ':'j', 'ㅏ':'k', 'ㅣ':'l', 'ㅋ':'z', 'ㅌ':'x', 'ㅊ':'c', 'ㅍ':'v', 'ㅠ':'b', 'ㅜ':'n', 'ㅡ':'m', 'ㅝ':"nj", 'ㅘ':"hk", 'ㅢ':"ml", 'ㅙ':"ho", 'ㅚ':"hl", 'ㅟ':"nl" }
